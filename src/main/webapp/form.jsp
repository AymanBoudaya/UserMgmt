...
<body class="container-fluid">
    ...
    <form action="UserController" method="post" class="form card" id="frm">
        ...
        <!-- Updated link: calls UserController with action=list -->
        <button class="btn btn-outline-success d-block">
            <a href="UserController?action=list">Show Users</a>
        </button>
    </form>
</body>
</html>
